...
async function main() {
    ...
    let md = `# Implementation Plan: UI Formatting & Product Details (Strict Factual Edition)\n\n`;
    
    md += `## 1. Price Display Formatting (UI Changes)\n`;
    ...
    md += `- **STRICT RULE**: NO prices will be modified in the database. I will only compute the math visually for the UI.\n\n`;
    ...
    md += `**STRICT RULE**: Only the \`description\` field will be modified. \`fabric\`, \`color\`, \`images\`, and all other fields will be left 100% untouched.\n\n`;
    
    md += `### Complete Proposal for all 98 Products\n\n`;
    md += `| Product Name | Proposed Factual Description |\n`;
    md += `|---|---|\n`;
